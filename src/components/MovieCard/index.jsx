...
const Description = props => {
    return (
        <div className="MovieCard__Description">
            ...
            laudantium eveniet libero, esse aspernatur tempore, expedita
            deleniti debitis fuga, voluptatum veritatis officia. Soluta quidem,
            odio quaerat magni nihil laborum minima? Aperiam, nulla ipsa!
        </div>
    );
};
