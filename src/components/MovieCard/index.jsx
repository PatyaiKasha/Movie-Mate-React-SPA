...
class MovieCard extends Component {
    ...
    render() {
        const { title, text, rating, onClick } = this.props;
        return ( <div className="MovieCard" act="action">
            <div className="MovieCard__Head">
                <div className="MovieCard__Title">{title}</div>
            </div>
            <Btn type="delete" text="Delete" className="MovieCard__btn MovieCard__btn_del" onClick={onClick}/>
